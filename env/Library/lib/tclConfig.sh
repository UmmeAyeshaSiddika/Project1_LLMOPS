...
# installed.
TCL_PREFIX='D:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library\include'
...
TCL_PACKAGE_PATH='D:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/KrishNayekAcademy/LLMOPS_Industry_Ready_Projects/Day1-14/Practice/project1_LLMOPS/env\Library\lib\tclstub86.lib'
